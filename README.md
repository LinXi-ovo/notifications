...
- 📰 **通知浏览**：按分类查看、搜索、筛选通知
- ✏️ **富文本编辑**：基于 wangEditor 的所见即所得编辑器，支持图文混排
- 📊 **Mermaid 流程图**：编辑器内通过 `[[!token]]` 占位，详情页自动渲染为 SVG
...
| 流程图 | Mermaid（数据分离方案，Token/Map 模式） |
...
VITE_COS_SECRET_ID=your_cos_secret_id_here
VITE_COS_SECRET_KEY=your_cos_secret_key_here
```
...
└── utils/          # 工具函数
design/             # 设计文档
├── mermaid.md              # Mermaid 架构设计
└── mermaid/encoding-safety.md  # 编码安全机制
doc/                # 其他文档
```

## 设计文档

- [Mermaid 架构设计](design/mermaid.md) — 数据分离方案、流程
- [编码安全机制](design/mermaid/encoding-safety.md) — HTML 编解码、双重编码预防
- [编辑器数据分离方案](plan/editor-data-strategy.md) — Token/Map 模式完整设计
